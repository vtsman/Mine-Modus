...
public class quantumMaterializer extends BlockContainer {

public quantumMaterializer(int par1, Material par2Material) {
...
Quantum_Materializer_TE TE;
public TileEntity createNewTileEntity(World par1World)
{
	TE = new Quantum_Materializer_TE();
return TE;
}
